...
public class SecureMessagingAPDUSender {
  ...
  public ResponseAPDU transmit(APDUWrapper wrapper, CommandAPDU commandAPDU) throws CardServiceException {
    ...
    System.out.println("plain CommandAPDU: " + Hex.bytesToHexString(plainCapdu.getBytes()));
    if (wrapper != null) {
      System.out.println("wrapper Before wrap: " + wrapper);
      commandAPDU = wrapper.wrap(commandAPDU);
      System.out.println("wrapper After wrap: " + wrapper);
    }
    System.out.println("transmit CommandAPDU: " + Hex.bytesToHexString(commandAPDU.getBytes()));
    ...
    if (wrapper == null) {
      ...
      try {
        ...
        System.out.println("wrapper Before unwrap: " + wrapper);
        responseAPDU = wrapper.unwrap(responseAPDU);
        System.out.println("wrapper After unwrap: " + wrapper);
    ...
    Test.COUNTER++;
    String commandResponseMessage = "Counter = " + Test.COUNTER + ", CAPDU = " + Hex.bytesToHexString(commandAPDU.getBytes()) + ", RAPDU = " + Hex.bytesToHexString(responseAPDU.getBytes());
    System.out.println(">>>>>>> APDU >>>>>: " + commandResponseMessage);

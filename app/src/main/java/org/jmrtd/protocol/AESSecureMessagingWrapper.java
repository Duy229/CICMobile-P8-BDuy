...
public class AESSecureMessagingWrapper extends SecureMessagingWrapper implements Serializable {
  ...
  public AESSecureMessagingWrapper(SecretKey ksEnc, SecretKey ksMac, int maxTranceiveLength, boolean shouldCheckMAC, long ssc) throws GeneralSecurityException {
    ...
    System.out.println("ksEnc=" + Hex.bytesToHexString(ksEnc.getEncoded()));
    System.out.println("ksMac=" + Hex.bytesToHexString(ksMac.getEncoded()));
  ...
  protected IvParameterSpec getIV() throws GeneralSecurityException {
    final byte[] sequenceCounter = getEncodedSendSequenceCounter();
    //System.out.println("EncodedSendSequenceCounter=" + Hex.bytesToHexString(sequenceCounter));
    byte[] encryptedSSC = sscIVCipher.doFinal(sequenceCounter);
    System.out.println("encryptedSSC=" + Hex.bytesToHexString(encryptedSSC));

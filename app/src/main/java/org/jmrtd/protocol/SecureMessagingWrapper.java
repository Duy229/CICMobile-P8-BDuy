  ...
  private CommandAPDU wrapCommandAPDU(CommandAPDU commandAPDU) throws GeneralSecurityException, IOException {
    ...
    try {
      ...
      if (lc > 0) {
        ...
        //System.out.println("do8587=" + Hex.bytesToHexString(do8587));
      }
      ...
      System.out.println("n=" + Hex.bytesToHexString(n));

      /* Compute cryptographic checksum... */
      mac.init(ksMac);
      byte[] cc = mac.doFinal(n);
      //System.out.println("cc=" + Hex.bytesToHexString(cc));
      ...
      //System.out.println("do8E=" + Hex.bytesToHexString(do8E));
    ...
    //System.out.println("dataFinal=" + Hex.bytesToHexString(data));

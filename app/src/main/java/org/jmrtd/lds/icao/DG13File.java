 ...
 *
 * $Id: DG13File.java 1802 2018-11-06 16:29:28Z martijno $
 */
...
public class DG13File extends DataGroup {
     ...
     */
    public DG13File(String nameOfHolder,
    ...
    protected void readContent(InputStream inputStream) throws IOException {
        ...
        if (tagListTag != TAG_LIST_TAG) {
            System.err.println("Expected tag list in DG13");
            //throw new IllegalArgumentException("Expected tag list in DG13");
        }
        ...
        for (int tag : tags) {
            switch (tag) {
                ...
                case CUSTODY_INFORMATION_TAG:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Unknown tag in DG13: " + Integer.toHexString(tag));
            }
        }
    }
    ...
    private void readField(int expectedFieldTag, TLVInputStream tlvInputStream) throws IOException {
        ...
        if (tag == CONTENT_SPECIFIC_CONSTRUCTED_TAG) {
            ...
            tlvInputStream.readLength();
            byte[] value = tlvInputStream.readValue();
            System.out.println("tlvInputStream.readValue=" + new String(value, StandardCharsets.UTF_8));
            switch (tag) {
                case FULL_NAME_TAG:
                ...
                case CUSTODY_INFORMATION_TAG:
                    ...
                    break;
                default:
                    System.err.println("Unknown field tag in DG13: " + Integer.toHexString(tag));
                    break;
                    //throw new IllegalArgumentException("Unknown field tag in DG13: " + Integer.toHexString(tag));
            }
        }
    }
}
